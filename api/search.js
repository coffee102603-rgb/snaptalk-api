...
const SEARCH_QUERIES = {
  ...
  kr: {
    // 한국인이 한국어로 말하는 영상 위주 (넓은 키워드로 결과 풀 확대)
    food: ['한국 음식', '한식 먹방', '한국 길거리 음식', '집밥 브이로그', '한식 레시피', '편의점 먹방', '분식 먹방', '한국 카페 브이로그', '백종원 레시피', '외국인 한국음식 반응', '한국 음식 소개', '시장 먹방'],
    people: ['한국 길거리 인터뷰', '한국 일상 브이로그', 'MZ 인터뷰', '대학생 브이로그', '직장인 브이로그', '한국인 일상', '연애 토크', '한국 사람들 인터뷰'],
    home: ['한국 생활 브이로그', '자취 브이로그', '하루 일과 브이로그', '아침 루틴 브이로그', '원룸 자취', '한국 집 브이로그', '주부 일상 브이로그', '한국 날씨 브이로그', '한국 사계절'],
    places: ['한국 여행', '서울 여행 브이로그', '제주도 여행', '부산 여행 브이로그', '서울 가볼만한곳', '국내여행 브이로그', '한국 명소', '경복궁 여행', '한국 관광지', '한국 여행 코스'],
    shopping: ['다이소 추천템', '올리브영 하울', '편의점 신상', '쿠팡 추천', '한국 쇼핑 브이로그', '장보기 브이로그', '한국 시장 구경'],
    fun: ['한국 챌린지', '커플 챌린지', '웃긴 영상 한국', '댄스 챌린지', '한국 밈', '한국 예능 짤'],
    cars: ['신차 리뷰 한국', '자동차 리뷰', '국산차 리뷰'],
    work: ['직장인 브이로그', '신입사원 브이로그', '면접 꿀팁', '한국 회사 생활'],
    culture: ['kpop 안무', '아이돌 직캠', '케이팝 커버댄스', '드라마 명장면', '예능 레전드', '아이돌 브이로그', '한복 브이로그', '케이팝 챌린지', '한국 전통문화', '한국 축제', 'kpop 댄스'],
    travel_english: ['한국 여행 꿀팁', '식당 주문 브이로그', '카페 주문 브이로그', '한국 지하철 타는법', '택시 타기', '편의점 이용', '관광지 브이로그', '한국 길거리 브이로그', '외국인 한국여행']
  }
};
